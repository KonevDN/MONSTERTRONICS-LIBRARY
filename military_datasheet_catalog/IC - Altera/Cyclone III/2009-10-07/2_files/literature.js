...
function assignCollapse(div) { 
	...
	if (div.getElementsByTagName(COLLAPSABLE_START_TYPE)[0].className=='literature-hb-topic' || (div.getElementsByTagName(COLLAPSABLE_START_TYPE)[0].className=='literature-hb-section' && myfilename=='lit-qts.jsp')) {
		collapsableIcon.setAttribute('state', -1); 
	} else {
    	collapsableIcon.setAttribute('state', 1); 
	}
