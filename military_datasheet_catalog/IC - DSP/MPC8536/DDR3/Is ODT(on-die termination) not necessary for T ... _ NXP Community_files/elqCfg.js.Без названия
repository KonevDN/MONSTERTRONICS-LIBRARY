...
var community=false;
for(ss=0;ss<10;ss++){
	if(scripts[ss].src.indexOf("community.freescale.com")>-1){
		community=true;
		break;
	}
}
...
var elqSiteID='';
if((scriptName.indexOf("www.nxp.com") >= 0 || scriptName.indexOf("cache.nxp.com") >= 0 || scriptName.indexOf("style.nxp.com") >= 0)&&(!community)){
	elqSiteID='1764';
}else if((scriptName.indexOf("www.freescale.com") >= 0 || scriptName.indexOf("cache.freescale.com") >= 0 || scriptName.indexOf("styles.freescale.com") >= 0)&&(!community)){
	elqSiteID='1764';
}else{
	elqSiteID='2716';
}
